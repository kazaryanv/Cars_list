...
@section('content')
    ...
    border: #1B242F;">
            ...
            <div style="background: #1B242F;border: #1B242F;" class="d-flex align-items-center justify-content-around pb-3">
                ...
                <a class="btn btn-outline-primary" href="{{route('cars.index')}}">Back</a>
            </div>
        </div>
    </div>
@endsection